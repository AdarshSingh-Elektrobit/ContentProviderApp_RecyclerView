...
//        holder.dept.setText(employeeList.get(position).dept);
        ...
        holder.Username.setText(employeeList.get(position).Username);
        holder.designation.setText(employeeList.get(position).designation);
        holder.name.setText(employeeList.get(position).name);
        holder.salary.setText(employeeList.get(position).salary);
